...
func TestCommandHelpBuilder_Build(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got := tt.builder.Build(rootCmd)

			// Strip ANSI colors for comparison
			gotStripped := output.StripANSIColors(got)
			wantStripped := output.StripANSIColors(tt.want)
...
func TestCommandHelpBuilder_DisableColor(t *testing.T) {
	...
	resultWithColor := builder.Build(rootCmd)
