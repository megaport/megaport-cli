...
func init() {
	...
	servicekeysHelp := &CommandHelpBuilder{
	...
	servicekeysCmd.Long = servicekeysHelp.Build()

	// create servicekey help
	createServiceKeyHelp := &CommandHelpBuilder{
	...
	createServiceKeyCmd.Long = createServiceKeyHelp.Build()

	// update servicekey help
	updateServiceKeyHelp := &CommandHelpBuilder{
	...
	updateServiceKeyCmd.Long = updateServiceKeyHelp.Build()

	// list servicekeys help
	listServiceKeysHelp := &CommandHelpBuilder{
	...
	listServiceKeysCmd.Long = listServiceKeysHelp.Build()

	// get servicekey help
	getServiceKeyHelp := &CommandHelpBuilder{
	...
	getServiceKeyCmd.Long = getServiceKeyHelp.Build()
