...
func init() {
	...
	mcrCmd.Long = mcrHelp.Build()

	// get MCR help
	getMCRHelp := &CommandHelpBuilder{
	...
	getMCRCmd.Long = getMCRHelp.Build()

	// buy MCR help
	buyMCRHelp := &CommandHelpBuilder{
  ...
  "promoCode": "SUMMER2024"
	...
	buyMCRCmd.Long = buyMCRHelp.Build()

	// update MCR help
	updateMCRHelp := &CommandHelpBuilder{
  ...
  "term": 24
	...
	updateMCRCmd.Long = updateMCRHelp.Build()

	// delete MCR help
	deleteMCRHelp := &CommandHelpBuilder{
	...
	deleteMCRCmd.Long = deleteMCRHelp.Build()

	// restore MCR help
	restoreMCRHelp := &CommandHelpBuilder{
	...
	restoreMCRCmd.Long = restoreMCRHelp.Build()

	// create prefix filter list help
	createPrefixFilterListHelp := &CommandHelpBuilder{
  ...
  "entries": [
	...
	createMCRPrefixFilterListCmd.Long = createPrefixFilterListHelp.Build()

	// list prefix filter lists help
	listPrefixFilterListsHelp := &CommandHelpBuilder{
	...
	listMCRPrefixFilterListsCmd.Long = listPrefixFilterListsHelp.Build()

	// get prefix filter list help
	getPrefixFilterListHelp := &CommandHelpBuilder{
	...
	getMCRPrefixFilterListCmd.Long = getPrefixFilterListHelp.Build()

	// update prefix filter list help
	updatePrefixFilterListHelp := &CommandHelpBuilder{
  ...
  "entries": [
	...
	updateMCRPrefixFilterListCmd.Long = updatePrefixFilterListHelp.Build()

	// delete prefix filter list help
	deletePrefixFilterListHelp := &CommandHelpBuilder{
	...
	deleteMCRPrefixFilterListCmd.Long = deletePrefixFilterListHelp.Build()
