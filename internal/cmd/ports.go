...
func init() {
  ...
  "costCentre": "IT-2023"
	...
	buyLagCmd.Long = buyLagHelp.Build()

	// list ports help
	listPortsHelp := &CommandHelpBuilder{
	...
	listPortsCmd.Long = listPortsHelp.Build()

	// get port help
	getPortHelp := &CommandHelpBuilder{
	...
	getPortCmd.Long = getPortHelp.Build()

	// update port help
	updatePortHelp := &CommandHelpBuilder{
  ...
  "term": 24
	...
	updatePortCmd.Long = updatePortHelp.Build()

	// delete port help
	deletePortHelp := &CommandHelpBuilder{
	...
	deletePortCmd.Long = deletePortHelp.Build()

	// restore port help
	restorePortHelp := &CommandHelpBuilder{
	...
	restorePortCmd.Long = restorePortHelp.Build()

	// lock port help
	lockPortHelp := &CommandHelpBuilder{
	...
	lockPortCmd.Long = lockPortHelp.Build()

	// unlock port help
	unlockPortHelp := &CommandHelpBuilder{
	...
	unlockPortCmd.Long = unlockPortHelp.Build()

	// check VLAN help
	checkVlanHelp := &CommandHelpBuilder{
	...
	checkPortVLANAvailabilityCmd.Long = checkVlanHelp.Build()
