...
func init() {
	...
	mveCmd.Long = mveHelp.Build()

	// buy MVE help
	buyMVEHelp := &CommandHelpBuilder{
  ...
  "vnics": [
	...
	buyMVECmd.Long = buyMVEHelp.Build()

	// get MVE help
	getMVEHelp := &CommandHelpBuilder{
	...
	getMVECmd.Long = getMVEHelp.Build()

	// update MVE help
	updateMVEHelp := &CommandHelpBuilder{
  ...
  "contractTermMonths": 24
	...
	updateMVECmd.Long = updateMVEHelp.Build()

	// delete MVE help
	deleteMVEHelp := &CommandHelpBuilder{
	...
	deleteMVECmd.Long = deleteMVEHelp.Build()

	// list MVE images help
	listMVEImagesHelp := &CommandHelpBuilder{
	...
	listMVEImagesCmd.Long = listMVEImagesHelp.Build()

	// list MVE sizes help
	listMVESizesHelp := &CommandHelpBuilder{
	...
	listAvailableMVESizesCmd.Long = listMVESizesHelp.Build()
