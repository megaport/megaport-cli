...
type MockMCRLookingGlassService struct {
	...
	ListBGPNeighborRoutesResult        []*megaport.LookingGlassBGPRoute
...
func (m *MockMCRLookingGlassService) ListBGPNeighborRoutes(ctx context.Context, req *megaport.ListBGPNeighborRoutesRequest) ([]*megaport.LookingGlassBGPRoute, error) {
