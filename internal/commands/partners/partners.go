...
var listPartnersCmd = &cobra.Command{
	...
	RunE:  utils.WrapOutputFormatRunE(ListPartners),
}
...
var findPartnersCmd = &cobra.Command{
	...
	RunE:  utils.WrapColorAwareRunE(FindPartners),
}
...
func AddCommandsTo(rootCmd *cobra.Command) {
	...
	partnersHelp := &help.CommandHelpBuilder{
	...
	partnersCmd.Long = partnersHelp.Build(rootCmd)

	// list partners help
	listPartnersHelp := &help.CommandHelpBuilder{
	...
	listPartnersCmd.Long = listPartnersHelp.Build(rootCmd)

	// find partners help
	findPartnersHelp := &help.CommandHelpBuilder{
	...
	findPartnersCmd.Long = findPartnersHelp.Build(rootCmd)
