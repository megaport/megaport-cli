...
var listLocationsCmd = &cobra.Command{
	...
	RunE:  utils.WrapOutputFormatRunE(ListLocations),
}
...
var getLocationCmd = &cobra.Command{
	...
	RunE:  utils.WrapOutputFormatRunE(GetLocation),
}
...
func AddCommandsTo(rootCmd *cobra.Command) {
	...
	locationsHelp := &help.CommandHelpBuilder{
	...
	locationsCmd.Long = locationsHelp.Build(rootCmd)

	// list locations help
	listLocationsHelp := &help.CommandHelpBuilder{
	...
	listLocationsCmd.Long = listLocationsHelp.Build(rootCmd)

	// get location help
	getLocationHelp := &help.CommandHelpBuilder{
	...
	getLocationCmd.Long = getLocationHelp.Build(rootCmd)
