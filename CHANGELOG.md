...
### Fixed
- pin GoReleaser project_name to megaport-cli (#561)

### Other Changes
- Update the MCR looking-glass commands for the reworked diagnostics API (#558)
...
[Unreleased]: https://github.com/megaport/megaport-cli/compare/v1.0.0-beta.3...HEAD
[v1.0.0-beta.3]: https://github.com/megaport/megaport-cli/compare/v1.0.0-beta.2...v1.0.0-beta.3
