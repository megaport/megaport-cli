...
### Added
- stream command output to the browser host as it is written in the WASM build, so interactive flows show inter-prompt context live instead of only at completion (ESD-1595)
