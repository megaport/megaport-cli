...
### Fixed
- send confirmation and other interactive prompts to stderr instead of stdout, so `--output json | jq` no longer breaks when a command asks for confirmation (ESD-1586)
