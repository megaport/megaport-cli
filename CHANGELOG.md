...
### Fixed
- bump the transitive `goldmark` dependency (pulled in via `glamour`, used to render docs) to v1.8.2 to resolve a govulncheck-flagged XSS vulnerability (GO-2026-5320)
